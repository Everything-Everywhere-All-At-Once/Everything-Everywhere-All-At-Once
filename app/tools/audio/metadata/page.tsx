            ...
            {TAG_FIELDS.map(({ key, label, placeholder }) => (
              <div key={key} className={key === "comment" ? "sm:col-span-2" : ""}>
                ...
                <input
                  ...
                  className="w-full bg-[#141414] border border-[#2a2a2a] rounded px-3 py-2 text-sm font-mono text-[#e4e4e7] placeholder:text-[#3f3f46] focus:outline-none focus:border-[#00E5FF] transition-colors"
                />
              </div>
            ))}
          </div>
