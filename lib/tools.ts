...
export const categories: Category[] = [
  ...
  },
  {
    ...
    icon: "◎",
    tools: [
      { name: "Text Summarizer", description: "Condense long content", href: "/tools/ai/summarize", status: "soon" },
      { name: "Grammar Checker", description: "Fix & improve writing", href: "/tools/ai/grammar", status: "soon" },
      { name: "Code Explainer", description: "Understand any code snippet", href: "/tools/ai/code", status: "soon" },
      { name: "Image Captioner", description: "Auto-describe images with AI", href: "/tools/ai/caption", status: "soon" },
      { name: "Prompt Builder", description: "Craft better AI prompts", href: "/tools/ai/prompt", status: "soon" },
    ],
  },
  {
    id: "webdesign",
